          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Kartu Belajar</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-3">
            ...
            <a href="../kartubelajar/kartubelajar.php?NIK=<?php echo $d['NIK']; ?>" class="btn btn-info btn-block margin-bottom">Kartu Belajar</a>
          ...
          <div class="col-md-9">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Kartu Belajar</h3>
                  ...
                  <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5>Kartu Belajar a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
                      </div>
                      <div class="modal-body">
                        <div class="card card-success">
                          <div class="card-header">
                            <h3 class="card-title">
                              <center>Kartu Belajar</center>
                            </h3>
                          </div>
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Materi Pelajaran</label>
              ...
              ?>
              <center>
                <h4>PT.Sumitomo Wiring Systems Batam Indonesia</h4>
                <h5>Kartu Belajar </h5>
              </center>
