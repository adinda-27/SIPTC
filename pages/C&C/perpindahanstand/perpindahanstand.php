...
<?php
  ...
  <a href="../perindahanstand/perpindahanstand.php?NIK=<?php echo $d['NIK']; ?>" class="btn btn-info btn-block margin-bottom">Basic Training</a>
 ...
 <div class="modal fade modalBesar<?php echo $d['NIK']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-lg">
    ...
    <tr>
                    ...
                    <a class="btn btn-primary btn-sm" href="recordstand.php?id=<?php echo $d['id']; ?>">
                          <i class="fas fa-eye">
                          </i>
                          View
                      </a>
