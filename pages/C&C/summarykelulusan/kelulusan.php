...
<?php
    ...
    <div class="card-body">
     <div class="media">
        ...
        <body>
        <center><img src="../../../dist/img/<?php echo $d['image']; ?>" class="mr-3" alt="..." style="width: 100px"></center>
  ...
  <a href="../perpindahanstand/perpindahanstand.php?NIK=<?php echo $d['NIK']; ?>" class="btn btn-primary btn-block margin-bottom">Basic Training</a>
  ...
  <div class="col-md-9">
    ...
    <img src="../../../dist/img/tc1.png" style="float:right;width:120px;height:100px;"></p>
             <h4><center><strong>SBI C&C Training</strong></center></h4>
             <h4><center><strong>Summary Kelulusan OJT</strong></center></h4>
        </div>
        <div class="card-body">
     <div class="media">
        <div class="media-body">
        ...
        <figure>
        <img src="../../../dist/img/<?php echo $d['image']; ?>" class="mr-3" alt="..." style="width: 120px">
         </figure>
        </div>
        </div>
    </body>
 ...
 <table border="1" cellspacing="0" cellpadding="5">
              <thead>
                  <tr>
                    ...
                    <th colspan="3"><center>Training 1</center></th>
                    <th colspan="2"><center>Hasil</center></th>
    </tr>
    <tr>
 ...
 <table border="1" cellspacing="0" cellpadding="5">
              <thead>
                  <tr>
                    <th rowspan="4">No</th>
                    <th rowspan="4">Materi</th>
                    <th colspan="2"><center>Standar Minimal</center></th>
                    <th colspan="3"><center>Result</center></th>
    </tr>
    <tr>
    ...
    <h6><strong><center>Member <font color=”green”><?php echo $d['NIK']; ?></font> dinyatakan <font color=”green”><?php echo $d['status']; ?></font></center> </strong></h6></div></div></div></div></div></div></div></div>
                <?php 
	}
	?>
  <div class="col-md-12">
 ...
 <table border="1" cellspacing="0" cellpadding="5">
              <thead>
                  <tr>
                    ...
                    <th rowspan="4">Materi</th>
                    <th colspan="3"><center>Standar Line</center></th>
                    <th colspan="3"><center>Training 1 (OJT 5 day)</center></th>
                    <th colspan="3"><center>Training 2 (Week 2)</center></th>
                    <th colspan="3"><center>Training 3 (Week 3)</center></th>
                    <th colspan="3"><center>Training 4 (Week 4)</center></th>
                    <th rowspan="4"><center>Hasil Akhir</center></th>
    </tr>
    <tr>
    ...
    <h4><strong><center>Member <font color=”green”><?php echo $d['NIK']; ?></font> dinyatakan <font color=”green”><?php echo $d['status']; ?></font></center> </strong></h4>       <div class="card-body">
  <table border="0">
  <thead>
  <tr>
 ...
 <div class="modal fade modalBesar<?php echo $d['NIK']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       ...
       <div class="card-header">
          <h3 class="card-title"><center>Tambah Hasil Test Teori</center></h3>
        </div>
       <div class="card-body">
     <div class="media">
        <div class="media-body">
