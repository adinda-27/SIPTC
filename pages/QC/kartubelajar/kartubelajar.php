        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Training Record List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php
  ...
  <a href="../kartubelajar/kartubelajar.php?NIK=<?php echo $d['NIK']; ?>" class="btn btn-info btn-block margin-bottom">Training Record List</a> 
  ...
  <div class="col-md-9">
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Training Record List</h3>
   ...
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       <div class="modal-header">
         <h5>Training Record List a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
       </div>
       <div class="modal-body">
       <div class="card card-success">
       <div class="card-header">
          <h3 class="card-title"><center>Training Record List</center></h3>
        </div>
       <div class="card-body">
       <div class="row">
                  <div class="col-md-6">
                  <form method="post" action="tambah_kartubelajar.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="NIK" name="date" placeholder="Masukkan Tanggal">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Materi Yang Sudah Dipelajari</label>
                      <input type="text" class="form-control" id="NIK" name="materi" placeholder="Masukkan Materi yang sudah dipelajari">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Pengajar</label>
                      <input type="text" class="form-control" id="NIK" name="pengajar" placeholder="Masukkan Nama Pengajar">
                    </div>
                    </div>
	...
	?>
        ...
        <h5>Quality Control Training Record List </h5> </center>
        ...
        <table id="table" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>No</th>
                    <th>Date</th>
                    <th>Materi Yang Sudah DIpelajari</th>
                    <th>Pengajar</th>
                    <th></th>
    </tr>
    </thead>
    <?php 
				...
				$data = mysqli_query($db,"select * from kartubelajar where NIK='$NIK'");
				$jumlah_data = mysqli_num_rows($data);
				$total_halaman = ceil($jumlah_data / $batas);
 
				$data_pegawai = mysqli_query($db,"select * from kartubelajar where NIK='$NIK' limit $halaman_awal, $batas");
