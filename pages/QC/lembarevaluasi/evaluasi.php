   ...
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       <div class="modal-header">
         <h5>Tambah data evaluasi a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
       </div>
       <div class="modal-body">
       <div class="card card-success">
       <div class="card-header">
          <h3 class="card-title"><center>Evaluasi</center></h3>
        </div>
       <div class="card-body">
       <div class="row">
                  <div class="col-md-6">
                  <form method="post" action="tambah_evaluasi.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="stand" name="bulan" placeholder="Masukkan nama bulan dan tahun skill up">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Line</label>
                      <input type="text" class="form-control" id="stand" name="line" placeholder="Masukkan nama Stand">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Stand</label>
                      <input type="text" class="form-control" id="NIK" name="stand" placeholder="Masukkan line member">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal</label>
                      <input type="date" class="form-control" id="NIK" name="tanggaleval" placeholder="Masukkan line member">
                    </div>
    ...
    <?php 
				...
				$data = mysqli_query($db,"select * from evaluasi where NIK='$NIK'");
				$jumlah_data = mysqli_num_rows($data);
				$total_halaman = ceil($jumlah_data / $batas);
 
				$data_pegawai = mysqli_query($db,"select * from evaluasi where NIK='$NIK' limit $halaman_awal, $batas");
    ...
    <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-primary btn-sm" href="lembareval.php?id=<?php echo $d['id']; ?>">
                          <i class="fas fa-eye">
                          </i>
                          View
                      </a>
                      <button type="button" class="btn btn-outline-dark btn-sm" data-toggle="modal" data-target="#modal-danger<?php echo $d['id']; ?>"><i class="fas fa-trash">Delete</i>
                </button>
