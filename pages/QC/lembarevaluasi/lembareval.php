      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>
                <font color="blue"><strong>QC Skill Map</strong></font>
              </h1>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content">
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Lembar Evaluasi Skill Up Plan di Quality Control</h3>
              </div>
              <div class="card-body">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="cb1" name="id_line" value="<?php echo $d['id']; ?>" />
                              <input type="hidden" name="NIK" value="<?php echo $d['NIK']; ?>" />
				                   1. Apakah Inspektor sudah mengerti pengetahuan dasar <br>
                           Simbol taping dan komponen yang tertera pada Zumen <br>
                           Toleransi dan jenis Ukuran <br>
                           Mengerti penyamaan dengan master sample W/H <br>
                           ...
                           2. Apakah inspektor melakukan pekerjaan sesuai dengan yang diajarkan oleh trainer? <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
          ...
          ?>
            <table id="" class="table table-bordered table-striped">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td> Apakah Inspektor sudah mengerti pengetahuan dasar <br>
                           Simbol taping dan komponen yang tertera pada Zumen <br>
                           Toleransi dan jenis Ukuran <br>
                           Mengerti penyamaan dengan master sample W/H </td>
                ...
                <tr>
                  <td>2</td>
                  <td> Apakah inspektor melakukan pekerjaan sesuai dengan yang diajarkan oleh trainer?</td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="cb1" name="id_line" value="<?php echo $d['id']; ?>" />
                              <input type="hidden" name="NIK" value="<?php echo $d['NIK']; ?>" />
				                   1. Apakah Inspektor melakukan pekerjaan sesaui SK dan onepoint lesson tanpa didampingi member asli/koordinator/trainer? <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb1" value="OK"> &nbsp; OK  &nbsp; &nbsp;
                           ...
                           2. Apakah Inspektor dapat menjelaskan point kerjanya/point penting, ciritical point dan bekerja sesuai urutan yang tertera di SK <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb3" value="OK"> &nbsp; OK  &nbsp; &nbsp;
    ...
    <table id="" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        ?>
          <tr>
            <td>1</td>
            <td>Apakah Inspektor melakukan pekerjaan sesaui SK dan onepoint lesson tanpa didampingi member asli/koordinator/trainer? </td>
            <td><?php echo $d['cb1']; ?></td>
            <td><?php echo $d['cb2']; ?></td>
            </td>
          </tr>
        <tr>
            <td>2</td>
            <td>Apakah Inspektor dapat menjelaskan point kerjanya/point penting, ciritical point dan bekerja sesuai urutan yang tertera di SK</td>
            <td><?php echo $d['cb3']; ?></td>
            <td><?php echo $d['cb4']; ?></td>
            </td>
          </tr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="cb1" name="id_line" value="<?php echo $d['id']; ?>" />
                              <input type="hidden" name="NIK" value="<?php echo $d['NIK']; ?>" />
				                   1. Apakah inspektor bisa bekerja sendiri tanpa melihat standar kerja dan memahami SK serta One Point lesson dengan baik? <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb1" value="OK"> &nbsp; OK  &nbsp; &nbsp;
                           <input type="radio" name="cb1" value="NG"> &nbsp; NG &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                           <label for="exampleInputFile">Evaluasi 2 :</label> &nbsp; &nbsp;
                           ...
                           2. Inspektor tidak membuat/meloloskan Defect <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb3" value="OK"> &nbsp; OK  &nbsp; &nbsp;
                           <input type="radio" name="cb3" value="NG"> &nbsp; NG &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                           <label for="exampleInputFile">Evaluasi 2 :</label> &nbsp; &nbsp;
  ...
  <table id="" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      ?>
        <tr>
          <td>1</td>
          <td>Apakah inspektor bisa bekerja sendiri tanpa melihat standar kerja dan memahami SK serta One Point lesson dengan baik? </td>
          <td><?php echo $d['cb1']; ?></td>
          <td><?php echo $d['cb2']; ?></td>
          </td>
        </tr>
        <tr>
          <td>2</td>
          <td>Inspektor tidak membuat/meloloskan Defect</td>
          <td><?php echo $d['cb3']; ?></td>
          <td><?php echo $d['cb4']; ?></td>
          </td>
        </tr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="cb1" name="id_line" value="<?php echo $d['id']; ?>" />
                              <input type="hidden" name="NIK" value="<?php echo $d['NIK']; ?>" />
				                   1. Apakah Inspektor dapat mengajarkan kepada Inspekto lain? <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb1" value="OK"> &nbsp; OK  &nbsp; &nbsp;
                           <input type="radio" name="cb1" value="OK"> &nbsp; NG <br>
                           <label for="exampleInputFile">Evaluasi 2 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb2" value="OK"> &nbsp; OK  &nbsp; &nbsp;
                           <input type="radio" name="cb2" value="OK"> &nbsp; NG <br>
                           2. Inspektor Memahami akibat dari defect yang terjadi serta dapat menemukan defect <br>
                           <label for="exampleInputFile">Evaluasi 1 :</label> &nbsp; &nbsp;
                           <input type="radio" name="cb3" value="OK"> &nbsp; OK  &nbsp; &nbsp;
                           <input type="radio" name="cb3" value="OK"> &nbsp; NG <br>
                           <label for="exampleInputFile">Evaluasi 2 :</label> &nbsp; &nbsp;
...
<table id="" class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    ?>
      <tr>
        <td>1</td>
        <td>Apakah inspektor dapat mengajarkan kepada inspektor lain?</td>
        <td><?php echo $d['cb1']; ?></td>
        <td><?php echo $d['cb2']; ?></td>
        </td>
      </tr>
      <tr>
        <td>2</td>
        <td> Inspektor Memahami akibat dari defect yang terjadi serta dapat menemukan defect</td>
        <td><?php echo $d['cb3']; ?></td>
        <td><?php echo $d['cb4']; ?></td>
        </td>
      </tr>
