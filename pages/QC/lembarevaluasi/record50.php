...
mysqli_query($db,"insert into item50 values('$id_line','$NIK','$cb1','$cb2','$model1', '$model2','$conveyor1','$conveyor2', '$operator1','$operator2','$jumlahpoin1','$jumlahpoin2','$poin1','$poin2','$persentase1','$persentase2','$cb3','$cb4')");
