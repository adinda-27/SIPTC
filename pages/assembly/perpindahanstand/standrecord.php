...
<?php
  ...
  <div class="col-md-9">
    ...
    <?php 
				...
				$data = mysqli_query($db,"select * from recordstand where id_line='$id'");
				$jumlah_data = mysqli_num_rows($data);
				$total_halaman = ceil($jumlah_data / $batas);
 
				$data_pegawai = mysqli_query($db,"select * from recordstand where id_line='$id' limit $halaman_awal, $batas");
