  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1><font color="blue"><strong>Assembly Only</strong></font></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">DataPegawai Assembly</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid"></br>
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Pegawai Assembly</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        $data = mysqli_query($db,"select * from pegawai where kode_section='450'");
        $jumlah_data = mysqli_num_rows($data);
        $total_halaman = ceil($jumlah_data / $batas);
        if(isset($_GET['search'])){
        $NIK = $_GET['search'];
        $data_pegawai = mysqli_query($db,"select * from pegawai where NIK='$NIK' and kode_section='450' limit $halaman_awal, $batas ");
        } else { 
        $data_pegawai = mysqli_query($db,"select * from pegawai where kode_section='450' limit $halaman_awal, $batas");
        }
				...
				while($d = mysqli_fetch_array($data_pegawai)){
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-primary btn-sm" href="summarykelulusan/kelulusan.php?NIK=<?php echo $d['NIK']; ?>">
                          <i class="fas fa-eye">
                          </i>
                          View
                      </a>
