        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../skilmap.php">Assembly Access</a></li>
...
<?php
  ...
  <a href="../skillmap/assemblyskill.php?NIK=<?php echo $d['NIK']; ?>" class="btn btn-info btn-block margin-bottom">Skill Map</a> 
  ...
  <div class="col-md-9">
          <div class="card card-info">
            <div class="card-header">
              ...
              <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target=".modalBesar<?php echo $d['NIK']; ?>"><i class="fas fa-folder">Tambah Data</i></button>
   ...
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       <div class="modal-header">
         <h5>Skill Map a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
       </div>
       <div class="modal-body">
       <div class="card card-info">
       <div class="card-header">
          <h3 class="card-title"><center>Skill Map</center></h3>
        </div>
       <div class="card-body">
       <div class="row">
                  <div class="col-md-6">
                  <form method="post" action="tambah_skillmap.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="NIK" name="line" placeholder="Masukkan nama line">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Proses</label>
                      <input type="text" class="form-control" id="NIK" name="proses" placeholder="Masukkan proses pegawai">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal</label>
                      <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Masukkan tanggal skill map">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Skill Up berikutnya</label>
                      <input type="date" class="form-control" id="skillup" name="skillup" placeholder="Masukkan tanggal skill up">
                    </div>
                    <div class="form-group">
                    <label>Nilai Pegawai</label><br>
                    <input type='radio' name='nilai' value='25' />&nbsp;25%
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='radio' name='nilai' value='50' />&nbsp;50%
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='radio' name='nilai' value='75' />&nbsp;75%
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='radio' name='nilai' value='100' />&nbsp;100%</br>
                    </select></div>
                    </div>
...
<?php 
		include '../../../config/koneksi.php';
		$no = 1;
		$data = mysqli_query($db,"select * from skillmap");
		while($d = mysqli_fetch_array($data)){
			?>
<script>
  $(function () {
...
<?php 
  ...
  document.getElementById("tanggal").addEventListener("change", function() {
    ...
    document.getElementById("skillup").value = tanggal.toISOString().substr(0, 10);
  });
</script>
</body>
</html>
