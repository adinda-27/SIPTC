...
<h4>
  <center>
    <font color="blue">"Lulus Training" <br></font> dan berhak untuk melanjutkan proses Assembly
  </center>
</h4>
<br></br>
<table border="0" cellspacing="0" cellpadding="0" align="left" width="300">
  <tr>
    <td align="left" width="300">Catatan Incarge Line:</td>
  </tr>
  <tr>
    <td></td>
    <td></td>
  ...
  <tr>
    <td></td>
    <td></td>
    <td align="right" width="200">Dibuat</td>
    <td align="right" width="200">Diperiksa</td>
    <td align="right" width="200">Disetujui</td>
  </tr>
  <tr>
    <td></td>
    <td></td>
    <td align="right">Romokio</td>
    <td align="right">Timawar</td>
    <td align="right">Jenni Tovrin Lubis</td>
  </tr>
  <tr>
    <td></td>
    <td></td>
    <td align="right">Trainer</td>
    <td align="right">Incarge Line</td>
    <td align="right">Supervisor</td>
  </tr>
</table>
<h2>
  <center>Dengan perolehan nilai : </center>
</h2><br>
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  Nilai Teori
</button>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalnilai">
  Nilai G-Star
</button>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Modalnilaiakhir">
  Nilai Skill Proses
</button>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Hasil Test Teori</h5>
...
<div class="modal fade" id="exampleModalnilai" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Hasil Test G-Star</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
?>
  ...
  Nilai Skill Proses
      ...
      <!-- Modal -->
<div class="modal fade" id="Modalnilaiakhir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
