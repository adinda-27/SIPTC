...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../contact/contact-us.php" class="nav-link active">Contact</a>
      </li>
    </ul>
            ...
            <div class="row justify-content-center">
             ...
             <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="d-flex justify-content-between">
                <a href="edit_profile.php" class="btn btn-sm btn-info mr-4">Edit Profile</a>
                <a href="#" class="btn btn-sm btn-success float-right">Profile Picture</a>
              </div>
            </div>
            ...
            <form action="proses_update.php" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                        ...
                        <input type="text" name="username" class="form-control form-control-alternative" placeholder="Username" value="<?php echo "".$_SESSION['username']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-nama">Nama</label>
                        <input type="text" name="nama" class="form-control form-control-alternative" placeholder="Nama" value="<?php echo "".$_SESSION['nama']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="text" name="email" class="form-control form-control-alternative" placeholder="email" value="<?php echo "".$_SESSION['email']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-first-name">Join Date</label>
                        <input type="date" name="join_date" class="form-control form-control-alternative" placeholder="Join Date" value="<?php echo "".$_SESSION['join_date']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Finish Kontrak</label>
                        <input type="date" name="finish_kontrak" class="form-control form-control-alternative" placeholder="Finish Kontrak" value="<?php echo "".$_SESSION['finish_kontrak']; ?>">
                      </div>
                    </div>
                  </div>
                <hr class="my-4">
                ...
                <div class="pl-lg-4">
                  <div class="col-md-12">
                      <div class="form-group focused">
                        ...
                        <input name="pass" class="form-control form-control-alternative" placeholder="New Password" value="" type="text">
                      </div>
                    </div>
                  </div>
                  </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group focused">
                    ...
                    <input name="about_me" class="form-control form-control-alternative" placeholder="About Me" value="<?php echo "".$_SESSION['about_me']; ?>" type="text">
                    </div>
                    <div class="pl-lg-12">
