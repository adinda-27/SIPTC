...
.btn-right {
  ...
  <title>SIP Training Center | DataTables</title>
    ...
    <section class="content">
      <div class="container-fluid">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="data.php" method="get"  style="float:right;">
        ...
        $nomor = $halaman_awal+1;
				while($d = mysqli_fetch_array($data_pegawai)){
                  ...
                  <tr>
                    ...
                    <td><img src="../../dist/img/<?php echo isset($d['image']) && !empty($d['image']) ? $d['image'] : '7309681.jpg'; ?>" width="100" /></td>
                    <td class="project-actions text-right">
                    <a class="btn btn-info btn-sm" href="detail.php?NIK=<?php echo $d['NIK']; ?>">
