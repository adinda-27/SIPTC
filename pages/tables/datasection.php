  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <font size="5" color="blue"><strong>Data Pegawai</strong></font>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="datasection.php" method="get"  style="float:right;">
        ...
        $NIK = $_GET['search'];
        $data_pegawai = mysqli_query($db,"select * from pegawai where NIK='$NIK' and kode_section='$kode_section' limit $halaman_awal, $batas ");
        } else {
				$data_pegawai = mysqli_query($db,"select * from pegawai where kode_section='$kode_section' limit $halaman_awal, $batas");
        }
				...
				while($d = mysqli_fetch_array($data_pegawai)){
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-primary btn-sm" href="pegawai/pegawai.php?NIK=<?php echo $d['NIK']; ?>">
                          <i class="fas fa-folder">
                          </i>
                          View
                      </a>
                      <a class="btn btn-info btn-sm" href="pegawai/modal_edit.php?NIK=<?php echo $d['NIK']; ?>">
