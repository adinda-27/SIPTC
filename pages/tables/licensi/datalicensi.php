...
.btn-right {
  ...
  <title>SIP Training Center | DataLicensi</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <section class="content">
        <a class="btn btn-primary" href="../licensi/form.php">
            <i class="fa fa-plus">
            </i>
            Tambah Data
        </a>
        ...
        <div class="container-fluid">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                 <form action="datalicensi.php" method="get"  style="float:right;">
            ...
            <div class="table-responsive">
                <table id="table" class="table table-bordered table-striped">
                  ...
                  $NIK = $_GET['search'];
                  $data_licensi = mysqli_query($db,"select * from licensi where NIK='$NIK' limit $halaman_awal, $batas ");
                  } else {
			          	$data_licensi = mysqli_query($db,"select * from licensi limit $halaman_awal, $batas");
                  }
        $nomor = 1;
