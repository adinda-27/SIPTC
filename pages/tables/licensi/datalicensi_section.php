  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <font size="5" color="blue"><strong>Licensi</strong></font>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../admin.php">Home</a></li>
              <li class="breadcrumb-item"><a href="../../examples/section.php">Section</a></li>
              <li class="breadcrumb-item active">Data Licensi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="modal fade" id="modalrenewal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" width="100%">
            <div class="modal-dialog">
                <div class="modal-content">
                	<!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Update Data Licensi</h4>
...
<br>
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable Licensi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="datalicensi_section.php" method="get"  style="float:right;">
...
<br></br>
        ...
        $batas = 10;
				...
				$previous = $halaman - 1;
				$next = $halaman + 1;
				$data = mysqli_query($db, "select * from licensi");
        $jumlah_data = mysqli_num_rows($data);
        $total_halaman = ceil($jumlah_data / $batas);
        if (isset($_GET['search'])) {
          $NIK = $_GET['search'];
          $data_licensi = mysqli_query($db, "select * from licensi where NIK='$NIK' and kode_section='$kode_section' limit $halaman_awal, $batas ");
        } else {
          $data = mysqli_query($db, "select * from licensi where kode_section='$kode_section'");
          $data_licensi = mysqli_query($db, "select * from licensi where kode_section='$kode_section' limit $halaman_awal, $batas");
        }
        $nomor = $halaman_awal + 1;
				while($d = mysqli_fetch_array($data_licensi)){
					?>
                    <tr>
 ...
 <div class="modal fade modalBesar<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       <div class="modal-header">
         <h5>Licensi <?php echo $d['no_licensi']; ?> a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
       </div>
       <div class="modal-body">
       <div class="card card-primary">
       <div class="card-header">
          <h3 class="card-title"><center>Licensi</center></h3>
        </div>
       <div class="card-body">
     <div class="media">
          ...
          <table border="0" cellspacing="0" cellpadding="0" align="left" width="450">
                ...
                <tr>
                    ...
                    <td><?php echo $d['exp_date']; ?></td>
                      ...
                      <a class="btn btn-info btn-sm" href="edit_licensi.php?id=<?php echo $d['id']; ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a class="btn btn-outline-light btn-sm" href="hapus_licensi.php?id=<?php echo $d['id']; ?>">Delete</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
