          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="tambah_licensi.php">
                  <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="no_licensi" name="no_licensi" placeholder="Enter No Licensi">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama Licensi</label>
                      <input type="text" class="form-control" id="nama_licensi" name="nama_licensi" placeholder="Nama Licensi">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Kode Section</label>
                      <input type="text" class="form-control" id="kode_section" name="kode_section" placeholder="Enter Kode Section">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nama Section</label>
                        <input type="text" class="form-control" id="section" name="nama_section" placeholder="Nama Section">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="exampleInputPassword1" name="exp_date">
                    </div>
                    <div class="form-group">
...
<script>
  ...
  document.getElementById("NIK").addEventListener("input", function() {
    ...
    fetch("getdatalicensi.php?NIK=" + NIK)
