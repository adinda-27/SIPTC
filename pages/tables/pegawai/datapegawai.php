      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="card-body">
            ...
            <select class="custom-select form-control-border" name="kode_section" id="kode_section" onchange="updateSection()">
            ...
            <input type="text" class="form-control-border" name="section" id="nama_section" readonly><br>
            </div>
            <div class="form-group">
          ...
          <div class="form-group">
                              ...
                              <div class="input-group">
                                  <div class="custom-file">
                                      <input id="file_img" type="file" name="image" value="../../../dist/img/default.jpg">
                                      <img id="img_preview" class="rounded mx-auto d-block" src="default.png">
                                  </div>
                              </div>
                          </div>
    ...
    <!-- /.modal -->
      <div class="container-fluid"></br>
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="datapegawai.php" method="get"  style="float:right;">
        ...
        $NIK = $_GET['search'];
        $data_pegawai = mysqli_query($db,"select * from pegawai where NIK='$NIK' limit $halaman_awal, $batas ");
        } else {
...
<script>
  function updateSection() {
    var kode_section = document.getElementById("kode_section").value;
    var nama_section = document.getElementById("nama_section");

    if (kode_section == "450") {
      nama_section.value = "Assembly";
    } else if (kode_section == "420") {
      nama_section.value = "QC";
    } else if (kode_section == "410") {
      nama_section.value = "C&C";
    } else {
      nama_section.value = "";
    }
  }
