...
<!-- /.sidebar -->
  ...
  <div class="content-wrapper">
	...
	while($d = mysqli_fetch_array($data)){
		?>
        <form role="form"  method="post" action="edit_pegawai.php">
                <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                  <div class="form-group ">
                    <label for="exampleInputEmail1">NIK</label>
                    <input type="text" class="form-control" name="NIK" placeholder="NIK" readonly value="<?php echo $d['NIK']; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis_kelamin" placeholder="Nama" value="<?php echo $d['jenis_kelamin']; ?>">
                  </div>
                  <div class="form-group">
            <label>Kode Section</label><br>
            <input type="text" name="kode_section" class="form-control" placeholder=""value="<?php echo $d['kode_section']; ?>">
          </div>
                  
                  <div class="form-group">
            <label>Section</label><br>
            <select class="custom-select form-control-border" id="exampleSelectBorder" name="section" value="<?php echo $d['section']; ?>">
                <option><?php echo $d['section']; ?></option>
          ...
          <div class="form-group">
            ...
            <input type="text" name="sub_section" class="form-control" placeholder=""value="<?php echo $d['sub_section']; ?>">
          </div>
          <div class="form-group"> 
            <label>Join Date</label><br>
            <input type="date" name="join_date" class="form-control" placeholder=""value="<?php echo $d['join_date']; ?>"><br>
          </div>
          <div class="form-group">
            <label>Finish Kontrak</label><br>
            <input type="text" name="finish_kontrak" class="form-control" placeholder=""value="<?php echo $d['finish_kontrak']; ?>">
    </div>
                  </div>
                  <div class="col-md-6">
    <div class="form-group">
            <label>Status</label><br>
            <select class="custom-select form-control-border" name="status" id="exampleSelectBorder"value="<?php echo $d['status']; ?>">
    ...
    <div class="form-group">
            ...
            <input type="text" name="ttl" placeholder="" class="form-control" value="<?php echo $d['ttl']; ?>">
    </div>
    <div class="form-group">
            <label>No HP</label><br>
            <input type="number" name="no_hp" placeholder="" class="form-control" value="<?php echo $d['no_hp']; ?>">
    </div>
    <div class="form-group">    
            <label>Alamat</label><br>
            <input type="text" name="alamat" placeholder="" class="form-control" value="<?php echo $d['alamat']; ?>">
    </div>
    <div class="form-group">
            <label>Agama</label><br>
            <input type="text" name="agama" placeholder="" class="form-control" value="<?php echo $d['agama']; ?>">
    </div>
    <div class="form-group">
            <label>Pekerjaan</label><br>
            <select class="custom-select form-control-border" name="pekerjaan" id="exampleSelectBorder"value="<?php echo $d['pekerjaan']; ?>">
                <option><?php echo $d['pekerjaan']; ?></option>
          ...
          <div class="form-group">
                              ...
                              <div class="input-group">
                                  <div class="custom-file">
                                      <input id="file_img" type="file" name="image"class="form-control" value="<?php echo $d['image']; ?>">
                                      <img id="img_preview" class="rounded mx-auto d-block" value="<?php echo $d['image']; ?>" src="../../../dist/img/default.jpeg">
                                  </div>
                              </div>
                          </div>
                </div>
