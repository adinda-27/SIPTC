...
<!-- /.sidebar -->
	...
	while($d = mysqli_fetch_array($data)){
     ...
     <div class="media">
        <div class="media-body">
          <body>
            <table border="0" cellspacing="0" cellpadding="1" align="left" width="500">
        ...
        <figure>
        <img src="../../../dist/img/<?php echo isset($d['image']) && !empty($d['image']) ? $d['image'] : '7309681.jpg'; ?>" class="mr-3" alt="..." style="width: 150px">
        <figcaption>
            <center><?php echo $d['nama']; ?></center>
            <center><?php echo $d['NIK']; ?></center>
            <center>Start : <?php echo $d['join_date']; ?></center>
            <center>End   : <?php echo $d['finish_kontrak']; ?></center>
        </figcaption>
         </figure>
        </div>
        </div>
      ...
      <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-align-justify"></i>&nbsp Riwayat</a>
      <div class="btn-group">
      <a class="btn btn-warning" href="../licensi/licensi.php?NIK=<?php echo $d['NIK']; ?>">
        <i class="fas fa-address-card">
        </i>
        Skill Licensi
    </a>&emsp;
    <a class="btn btn-success" href="../penghargaan/penghargaan.php?NIK=<?php echo $d['NIK']; ?>">
  ...
  <span class="caret"></span></button>&emsp;
  <ul class="dropdown-menu">
    <li><a href="../pengalamaninternal/pkinternal_pegawai.php?NIK=<?php echo $d['NIK']; ?>" class="nav-link">&emsp; Internal</a></li>
    <li><a href="../pengalamaneksternal/pengalamankerja.php?NIK=<?php echo $d['NIK']; ?>" class="nav-link">&emsp; Eksternal</a></li>
  </ul>
</div>
<a class="btn btn-danger" href="../renewal/renewalpegawai.php?NIK=<?php echo $d['NIK']; ?>">
