...
.btn-right {
  ...
  <title>SIP TC | DataPengalamanKerja</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Pengalaman Kerja</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="../../examples/section.php">Section</a></li>
              <li class="breadcrumb-item active">Pengalaman Kerja Eksternal </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <a class="btn btn-primary" href="tambahpengalamankerja.php">
            <i class="fa fa-plus">
            </i>
            Tambah Data
        </a>
        ...
        <div class="container-fluid">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable Pengalaman Kerja</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="datapengalamankerja.php" method="get"  style="float:right;">
    ...
    $data = mysqli_query($db,"select * from pk_eksternal");
    $jumlah_data = mysqli_num_rows($data);
    $total_halaman = ceil($jumlah_data / $batas);
    if(isset($_GET['search'])){
    $NIK = $_GET['search'];
    $data = mysqli_query($db,"select * from pk_eksternal where NIK='$NIK' limit $halaman_awal, $batas ");
    } else {
		$data = mysqli_query($db,"select * from pk_eksternal");
    }
