...
<!-- /.sidebar -->
  ...
  <div class="content-wrapper">
	...
	include '../../../config/koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($db,"select * from pk_eksternal where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
                <form role="form"  method="post" action="pkedit_eksternal.php">
                  <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Masukkan NIK pegawai" name="NIK" value="<?php echo $d['NIK']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nama" name="nama" value="<?php echo $d['nama']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama Perusahaan</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nama Perusahaan" name="nama_perusahaan" value="<?php echo $d['nama_perusahaan']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Jabatan</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Jabatan" name="jabatan" value="<?php echo $d['jabatan']; ?>">
                      </div>
</div>
                    <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="exampleInputPassword1" name="end_date" value="<?php echo $d['end_date']; ?>">
                  </div>
                    <div class="form-group">
                      <label for="exampleInputFile">File input</label>
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="exampleInputFile" name="surat_pk">
                          <label class="custom-file-label" for="exampleInputFile"><?php echo $d['surat_pk']; ?></label>
                        </div>
                        <div class="input-group-append">
