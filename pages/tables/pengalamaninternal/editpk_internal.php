...
.btn-right {
  ...
  <title>SIP TC | PK Internal</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pengalaman Kerja Internal</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Pengalaman Kerja Internal</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Pengalaman Kerja Internal</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?php
	include '../../../config/koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($db,"select * from pk_internal where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
                <form role="form"  method="post" action="pkedit_internal.php">
                  <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                      ...
                      <input type="number" class="form-control" id="nik" placeholder="Masukkan NIK Pegawai" name="NIK" value="<?php echo $d['NIK']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nama</label>
                        <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Pegawai" name="nama" value="<?php echo $d['nama']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Section Sebelumnya</label>
                        <select class="custom-select form-control-border" id="section" name="section_sebelum" value="<?php echo $d['section_sebelum']; ?>">
                        <option><?php echo $d['section_sebelum']; ?></option>
                        <option>None</option>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1">Section Proccess Sebelumnya</label>
                        <input type="text" class="form-control" id="proses" placeholder="Section Proccess" name="proses_sebelum" value="<?php echo $d['proses_sebelum']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Section Sekarang</label>
                        <input type="text" class="form-control" id="sectionsekarang" placeholder="Section Sekarang" name="section_sekarang"value="<?php echo $d['section_sekarang']; ?>">
                      </div>
                      </div>
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Section Proccess Sekarang</label>
                        <input type="text" class="form-control" id="sectionproses" placeholder="Section Proccess" name="proses_sekarang" value="<?php echo $d['proses_sekarang']; ?>">
                      </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Start Date</label>
                        <input type="date" class="form-control" id="startdate" name="start_date" value="<?php echo $d['start_date']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">End Date</label>
                      <input type="date" class="form-control" id="end_date" name="end_date"value="<?php echo $d['end_date']; ?>">
                  </div>
                    <div class="form-group">
                      <label for="exampleInputFile">Surat Transfer Member</label>
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="transfermember" name="surat_tfmember">
                          <label class="custom-file-label" for="exampleInputFile"><?php echo $d['surat_tfmember']; ?></label>
                        </div>
                        <div class="input-group-append">
