...
.btn-right {
  ...
  <title>SIP TC | Data PK Internal</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <section class="content">
        <a class="btn btn-primary" href="tambahPK_internal.php">
            <i class="fa fa-plus">
            </i>
            Tambah Data
        </a>
        ...
        <div class="container-fluid">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable Pengalaman Kerja Internal</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="pk_internal.php" method="get"  style="float:right;">
            <input type="text" name="search" placeholder="Masukkan NIK">
            <button class="btn btn-primary btn-sm" type="submit">Cari</button>
            </form>
            <br></br>
              <div class="table-responsive">
                <table id="table" class="table table-bordered table-striped table-primary">
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>NIK</th>
    ...
    $data = mysqli_query($db,"select * from pk_internal");
    $jumlah_data = mysqli_num_rows($data);
    $total_halaman = ceil($jumlah_data / $batas);
    if(isset($_GET['search'])){
    $NIK = $_GET['search'];
    $data = mysqli_query($db,"select * from pk_internal where NIK='$NIK' limit $halaman_awal, $batas ");
    } else {
		$data = mysqli_query($db,"select * from pk_internal");
		}
    ...
    while($d = mysqli_fetch_array($data)){
			?>
                    <tr>
                      ...
                      <td><?php echo date("d-m-Y", strtotime($d['end_date'])); ?></td>
                      <td><img src="../../../dist/img/a.jpg" width="100" /></td>
   ...
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       <div class="modal-header">
         <h5>Pengalaman Kerja Internal a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
       </div>
       <div class="modal-body">
       <div class="card card-primary">
       <div class="card-header">
          <h3 class="card-title"><center>Pengalaman Kerja</center></h3>
        </div>
       <div class="card-body">
     <div class="media">
        <div class="media-body">
          ...
          <table border="0" cellspacing="0" cellpadding="0" align="left" width="450">
                ...
                <tr>
                    <td>Section Sebelumnya</td>
                    <td><?php echo $d['section_sebelum']; ?></td>
                </tr>
                <tr>
                    <td>Section Proccess Sebelumnya</td>
                    <td><?php echo $d['proses_sebelum']; ?></td>
                </tr>
                <tr>
                    <td>Section Sekarang</td>
                    <td><?php echo $d['section_sekarang']; ?></td>
                </tr>
                <tr>
                    <td>Section Proccess Sekarang</td>
                    <td><?php echo $d['proses_sekarang']; ?></td>
                </tr>
                <tr>
                    <td>Start Date</td>
       ...
       <figure>
        <center><img src="../../../dist/img/a.jpg" class="mr-3" alt="..." style="width: 250px"></center>
    </figure>
     </div>
     </div>
     </div>
                        ...
                        <a class="btn btn-info btn-sm" href="editpk_internal.php?id=<?php echo $d['id']; ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a class="btn btn-outline-light btn-sm" href="hapuspk_internal.php?id=<?php echo $d['id']; ?>">Delete</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
