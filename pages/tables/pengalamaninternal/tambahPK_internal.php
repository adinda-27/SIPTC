        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../../../pages/examples/section.php">Section</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form"  method="post" action="pktambah_internal.php">
                  <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">NIK</label>
                      <input type="number" class="form-control" id="nik" placeholder="Masukkan NIK Pegawai" name="NIK">
                    </div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select form-control-border" id="section" name="section_sebelum">
                        <option>None</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="proses" placeholder="Section Proccess" name="proses_sebelum">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Section Sekarang</label>
                        <input type="text" class="form-control" id="sectionsekarang" placeholder="Section Sekarang" name="section_sekarang">
                      </div>
                      </div>
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Section Proccess Sekarang</label>
                        <input type="text" class="form-control" id="sectionproses" placeholder="Section Proccess" name="proses_sekarang">
                      </div>
                    <div class="form-group">
