...
<div class="wrapper">
 ...
 <nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item">
      <a href="../../tables/pegawai/datapegawai.php" class="nav-link active">
...
<!-- /.sidebar -->
  ...
  <div class="content-wrapper">
	...
	include '../../../config/koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($db,"select * from penghargaan where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
                <form role="form"  method="post" action="penghargaan_edit.php">
                  <div class="card-body">
                    <div class="row">
                    <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" name="NIK" placeholder="NIK" value="<?php echo $d['NIK']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="nama" placeholder="Nama Pegawai" value="<?php echo $d['nama']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">No Penghargaan</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="no_penghargaan" placeholder="Enter No Penghargaan"value="<?php echo $d['no_penghargaan']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama Penghargaan</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="nama_penghargaan" placeholder="Nama Penghargaan" value="<?php echo $d['nama_penghargaan']; ?>">
                    </div>
</div>
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nama Pemberi</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="nama_pemberi" placeholder="Nama Pemberi"value="<?php echo $d['nama_pemberi']; ?>">
                      </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Institusi</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="institusi" placeholder="Institusi Pemberi Penghargaan" value="<?php echo $d['institusi']; ?>">
                  </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Tahun Diterima</label>
                        <input type="datetime" class="form-control" id="exampleInputPassword1" name="tahun_diterima" placeholder="Tahun Diterima"value="<?php echo $d['tahun_diterima']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputFile">File input</label>
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="exampleInputFile" name="penghargaan" value="<?php echo $d['penghargaan']; ?>">
                          <label class="custom-file-label" for="exampleInputFile"><?php echo $d['penghargaan']; ?></label>
                        </div>
                        <div class="input-group-append">
