  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Renewal</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../admin.php">Home</a></li>
              <li class="breadcrumb-item"><a href="../../examples/section.php">Section</a></li>
              <li class="breadcrumb-item"><a href="renewal.php">Data Renewal</a></li>
              <li class="breadcrumb-item active">Tambah Renewal</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Tambah Renewal</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?php
	include '../../../config/koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($db,"select * from renewal where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
                <form method="post" action="update_renewal.php">
                  <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="NIK" name="NIK" placeholder="Masukkan NIK Pegawai" value="<?php echo $d['NIK']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama</label>
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Pegawai" value="<?php echo $d['nama']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Kode Section</label>
                      <input type="text" class="form-control" id="nama" name="kode_section" placeholder="Masukkan Nama Pegawai" value="<?php echo $d['kode_section']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">No Licensi</label>
                        <input type="text" class="form-control" id="no_licensi" name="no_licensi" placeholder="Masukkan No Licensi Pegawai" value="<?php echo $d['no_licensi']; ?>">
                      </div>
                      </div>
                      <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="action" name="action" value="<?php echo $d['action']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Exp Date</label>
                        <input type="date" class="form-control" id="exp_date" name="exp_date" value="<?php echo $d['exp_date']; ?>">
                    </div>
                  <!-- /.card-body -->
...
document.getElementById("action").addEventListener("input", function() {
  ...
  var exp_date = new Date(action);
  exp_date.setMonth(exp_date.getMonth() + 12);
  exp_date.setTime(exp_date.getTime() - (24 * 60 * 60 * 1000));

  // format the exp_date as a string
  var exp_date_string = exp_date.toISOString().slice(0,10);

  // update the exp_date field with the calculated date
  document.getElementById("exp_date").value = exp_date_string;
});
</script>
    </body>
    </html>