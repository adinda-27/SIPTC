...
<!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="btn-group">
      <ul class="left">
        <a class="btn btn-primary btn-sm" href="tambahrenewal.php">
            <i class="fa fa-plus">
            </i>
            Tambah Data
        </a></ul>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="container-fluid">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="renewal.php" method="get"  style="float:right;">
        ...
        if(isset($_GET['tanggal'])){
          $exp_date = $_GET['tanggal'];
          $data_renewal = mysqli_query($db,"select * from renewal where exp_date='$exp_date' limit $halaman_awal, $batas ");
        }elseif(isset($_GET['search'])){
          $NIK = $_GET['search'];
          $data_renewal = mysqli_query($db,"select * from renewal where NIK='$NIK' limit $halaman_awal, $batas ");
        }else{
          $data_renewal = mysqli_query($db,"select * from renewal limit $halaman_awal, $batas");
        }
				...
				while($d = mysqli_fetch_array($data_renewal)){
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td> <?php
include '../../../config/koneksi.php';
  $query = "SELECT action FROM renewal limit $halaman_awal, $batas";
$result = mysqli_query($db, $query);
$tanggal = mysqli_fetch_assoc($result);
if ($tanggal['action'] != '0000-00-00') {
  echo $tanggal['action'];
} else {
  echo "No Data";
}
 ...
 <div class="modal fade modalBesar<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-lg">
     ...
     <div class="modal-content">
       ...
       <div class="card-header">
          <h3 class="card-title"><center>Renewal</center></h3>
        </div>
       <div class="card-body">
     <div class="media">
