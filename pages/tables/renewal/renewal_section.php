    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <font size="5" color="blue"><strong>Renewal</strong></font>
            </div>
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <form method="POST" action="download.php">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#downloadModal">
              Download Laporan
            </button> <button type="button" class="btn btn-primary" style="margin-left: auto;" data-toggle="modal" data-target="#modalrenewal">
					Update Data
				</button>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="downloadModalLabel">Pilih Bulan dan Tahun</h5>
                  ...
                  <div class="modal-body">
                    <?php
                    include '../../../config/koneksi.php';
                    if (isset($_GET['kode_section'])) {
                      $kode_section = $_GET['kode_section'];
                    ?>
                      <input type="hidden" name="kode_section" value="<?php echo $kode_section; ?>">
                    <?php
                    }
                    ?>
                    <select name="bulan">
        ...
        <div class="modal fade" id="modalrenewal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" width="100%">
            <div class="modal-dialog">
                <div class="modal-content">
                	<!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Update Data Renewal</h4>
...
<br>
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">DataTable Renewal</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <form action="renewal_section.php" method="get"  style="float:right;">
...
<br></br>
             <div class="table-responsive">
              <table id="table1" class="table table-bordered table-striped">
                ...
                $previous = $halaman - 1;
                $next = $halaman + 1;
                $data = mysqli_query($db,"select * from renewal");
				        $jumlah_data = mysqli_num_rows($data);
				        $total_halaman = ceil($jumlah_data / $batas);
                if(isset($_GET['search'])){
                $NIK = $_GET['search'];
				        $data_renewal = mysqli_query($db,"select * from renewal where NIK='$NIK' and kode_section='$kode_section' limit $halaman_awal, $batas ");
                } else {
                    $data = mysqli_query($db, "select * from renewal where kode_section='$kode_section'");
                    $data_renewal = mysqli_query($db, "select * from renewal where kode_section='$kode_section' limit $halaman_awal, $batas");
                }
                $nomor = $halaman_awal + 1;
                while ($d = mysqli_fetch_array($data_renewal)) {
                ?>
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo date("d-m-Y", strtotime($d['start_date'])); ?></td>
                      <td><?php echo date("d-m-Y", strtotime($d['exp_date'])); ?></td>
                      <td><?php 
// koneksi database
include '../../../config/koneksi.php';
//query to get data from renewal table
$query = "SELECT DATE_FORMAT(start_date, '%d-%m-') AS tanggal_bulan, YEAR(exp_date) as tahun FROM renewal WHERE id = '".$d['id']."'";
$result = mysqli_query($db, $query);

while ($data = mysqli_fetch_assoc($result)) {
  echo $data['tanggal_bulan'] . $data['tahun'];
}
?>
</td>
                      <td class="project-actions text-right">
                        ...
                        <div class="modal fade modalBesar<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                          <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5>Renewal <?php echo $d['no_licensi']; ?> a/n <?php echo $d['nama']; ?>,<?php echo $d['NIK']; ?> </h5>
                              </div>
                              <div class="modal-body">
                                  ...
                                  <div class="card-body">
                                    <div class="media">
                                      <div class="media-body">
                                        ...
                                        <a href="pegawai.php?NIK=<?php echo $d['NIK']; ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Kunjungi Profile Ini</a>
                        ...
                        <a class="btn btn-info btn-sm" href="edit_renewal.php?id=<?php echo $d['id']; ?>">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content bg-danger">
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <a class="btn btn-outline-light btn-sm" href="hapus_renewal.php?id=<?php echo $d['id']; ?>">Delete</a>
                              </div>
                            </div>
                            <!-- /.modal-content -->
                          </div>
  ...
  <ul class="pagination justify-content-end">
    <li class="page-item">
      <a class="page-link" <?php if ($halaman > 1) {
                                echo "href='?kode_section=$kode_section&halaman=$previous'";
                              } ?>>Previous</a>
    </li>
    <?php
    ...
    ?>
      <li class="page-item"><a class="page-link" href="?kode_section=<?php echo $kode_section; ?>&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
    <?php
    }
    ...
    <li class="page-item">
      <a class="page-link" <?php if ($halaman < $total_halaman) {
                                echo "href='?kode_section=$kode_section&halaman=$next'";
                              } ?>>Next</a>
    </li>
      </ul>
    </nav>
