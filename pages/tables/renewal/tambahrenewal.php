          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="tambah_renewal.php">
                  <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEmail1">NIK</label>
                      <input type="number" class="form-control" id="NIK" name="NIK" placeholder="Masukkan NIK Pegawai">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="kode_section" name="kode_section" placeholder="Masukkan Kode Section">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">No Licensi</label>
                        <input type="text" class="form-control" id="no_licensi" name="no_licensi" placeholder="Masukkan No Licensi Pegawai">
                      </div>
                      </div>
                      <div class="col-md-6">
                      <div class="form-group">
...
<script>
  ...
  document.getElementById("NIK").addEventListener("input", function() {
    ...
    .then(data => {
      ...
      document.getElementById("kode_section").value = data.kode_section;
...
document.getElementById("start_date").addEventListener("input", function() {
  ...
  var exp_date = new Date(start_date);
