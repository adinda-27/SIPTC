...
.btn-right {
  ...
  <title>SIP Training Center | Data User</title>
 ...
 <nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    <!-- Add icons to the links using the .nav-icon class
        ...
        <li class="nav-item">
                <a href="pages/tables/user.php" class="nav-link active">
                  <i class="nav-icon fas fa-border-all"></i>
                  <p>Data User</p>
                </a>
              </li>
    ...
    <li class="nav-item">
      <a href="pages/datapegawai.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <section class="content">
        <a class="btn btn-primary" href="../tables/tambahuser.php">
            <i class="fa fa-plus">
            </i>
            Tambah Data
        </a>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="project-actions text-right">
                        ...
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_modal"><span class="fas fa-trash"></span>
                          Delete
                        </button>
